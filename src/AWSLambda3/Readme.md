...
WORKDIR /src
COPY ["AWSLambda3.csproj", "AWSLambda3/"]
RUN dotnet restore "AWSLambda3/AWSLambda3.csproj"

WORKDIR "/src/AWSLambda3"
COPY . .
RUN dotnet build "AWSLambda3.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSLambda3.csproj" \
